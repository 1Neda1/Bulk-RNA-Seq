...
legend("bottomright", legend=c("logFC > 1", "logFC < -1","Significant","no-significant"),
       col=c("red", "blue","green","black"),  pch=20, cex=0.8,text.width = 2,text.font = 2, x.intersp=0.8, y.intersp=0.8)
